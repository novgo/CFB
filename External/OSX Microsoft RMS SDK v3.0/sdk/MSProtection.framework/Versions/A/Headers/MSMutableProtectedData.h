...
/*!
 ...
 @class
 @see documentation at http://msdn.microsoft.com/en-us/library/windows/desktop/dn237759(v=vs.85).aspx
 
 */
@interface MSMutableProtectedData : MSProtectedData

+ (void)protectedDataWithPolicy:(MSProtectionPolicy *)protectionPolicy
...
- (void)protectedDataInFile:(NSString *)path
      originalFileExtension:(NSString *)originalFileExtension
       withProtectionPolicy:(MSProtectionPolicy *)protectionPolicy
            completionBlock:(void(^)(MSMutableProtectedData *data, NSError *error))completionBlock;
